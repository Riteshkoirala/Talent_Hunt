    ...
    <div class="contai">
        <div class="job_container">
            ...
            <form action="{{ route('profiles.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <p>Firstname: </p>
                <input type="text" name="firstname" placeholder="john">@error('firstname') {{ $message }} @enderror<br><br>
                ...
                <p>Current Image: </p> <input type="file" accept="image/*" name="image" >@error('image') {{ $message }} @enderror<br><br>
                <p>CV: </p> <input type="file" accept=".doc, .docx, .pdf" name="cv" >@error('cv') {{ $message }} @enderror<br><br>
