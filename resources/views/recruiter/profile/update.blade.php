    ...
    <div class="contai">
        <div class="job_container">
            ...
            <form action="{{ route('profile.update',$profile->id) }}" method="post" enctype="multipart/form-data">
                ...
                <p>Location: </p> <input type="text" name="location" placeholder="company location" value="{{$profile->location}}">@error('location'){{ $message }} @enderror<br><br>
                <p>Contact_number: </p> <input type="text" name="contact_number" placeholder="number" value="{{ $profile->contact_number }}">@error('contact_number'){{ $message }} @enderror<br><br>
